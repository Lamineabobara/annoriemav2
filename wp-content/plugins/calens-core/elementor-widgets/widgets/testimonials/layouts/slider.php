...
$owl_options = array(
	...
	'center'     => isset( $settings['post_enable_slider_center'] ) ? $settings['post_enable_slider_center'] : false,
...
?>
<div class="owl-carousel owl-theme calens-service-wrapper" data-owl_options="<?php echo esc_attr( json_encode( $owl_options ) ); ?>">
	<?php
