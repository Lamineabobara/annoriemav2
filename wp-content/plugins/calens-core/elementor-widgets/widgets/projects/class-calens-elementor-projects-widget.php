 ...
 * Projects Widget.
 */
class Calens_Elementor_Projects_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'calens-projects';
	}
	...
	public function get_title() {
		return esc_html__( 'Projects', 'calens-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'calens_section_project_settings',
			[
		...
		$this->add_control(
			'style',
			[
				'label'   => esc_html__( 'Project Style', 'calens-core' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'style-1',
				'options' => [
		...
		$this->add_control(
			'post_per_page',
			[
				'label' => esc_html__( 'Projects Count', 'calens-core' ),
	...
	protected function render() {
		...
		$calens_widget_class_unique = 'tcr-projects-' . mt_rand();
		$calens_widget_class_unique = 'tcr_projects_wrapper';
		$calens_widget_classes      = 'tcr-elementor-widget';
		$calens_widget_classes     .= ' ' . $calens_widget_class_unique;
		$calens_widget_classes     .= ' projects-' . $settings['style'];
		$calens_widget_classes     .= ' projects-layout-' . $settings['layout'];
		?>
