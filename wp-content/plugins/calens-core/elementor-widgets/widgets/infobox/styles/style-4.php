...
<div class="tcr-infobox-wrapper">
	<div class="tcr-infobox-inner d-flex align-items-center">
	<?php
	if ( $settings['add_icon'] ) {
		...
		if ( $settings['infobox_title'] ) {
			?>
			<h3 class="tcr-infobox-title"><?php echo $settings['infobox_title']; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></h3>
			<?php
		}
	}
	?>
...
<div class="tcr-infobox-content">
	...
	if ( $settings['infobox_content'] ) {
		?>
		<div class="tcr-infobox-text"><?php echo esc_attr( $settings['infobox_content'] ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></div>
		<?php
	}
