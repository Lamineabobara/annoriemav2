 ...
 * Services Widget.
 */
class Calens_Elementor_Services_Widget extends \Elementor\Widget_Base {

	public function get_name() {
		return 'calens-services';
	}
	...
	public function get_title() {
		return esc_html__( 'Services', 'calens-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'calens_section_service_settings',
			[
		...
		$this->add_control(
			'style',
			[
				'label'   => esc_html__( 'Service Style', 'calens-core' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'style-1',
				'options' => [
		...
		$this->add_control(
			'post_per_page',
			[
				'label' => esc_html__( 'Services Count', 'calens-core' ),
		...
		// Slider Settings
		$this->start_controls_section(
			'calens_section_service_slider_settings',
			[
		...
		// Grid Settings
		$this->start_controls_section(
			'calens_section_service_grid_settings',
			[
	...
	protected function render() {
		...
		$calens_widget_class_unique = 'tcr-services-' . mt_rand();
		$calens_widget_classes      = 'tcr-elementor-widget';
		$calens_widget_class_unique = 'tcr_services_wrapper';
		$calens_widget_classes     .= ' ' . $calens_widget_class_unique;
		$calens_widget_classes     .= ' services-' . $settings['style'];
		$calens_widget_classes     .= ' services-layout-' . $settings['layout'];
		?>
